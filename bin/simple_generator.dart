...
Future<void> main(List<String> arguments) async {
  try {
    ...
    final symbolMatches = RegExp(r'<symbol[^>]*id="([^"]*)"[^>]*>(.*?)</symbol>', dotAll: true)
        .allMatches(content);
    ...
    for (final match in symbolMatches) {
      ...
      cases.writeln('          <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">');
    ...
    // 生成文件内容
    final template = nullSafety ? _getNullSafetyTemplate() : _getRegularTemplate();
